...
using DF.RealEstate.Core.Base;
using DF.RealEstate.Core.Extensions;
using DF.RealEstate.Dto;
using DF.RealEstate.Types;

namespace DF.RealEstate.Queries
{
    public class OrganizationUnitQuery : RealEstateQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
