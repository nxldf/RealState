...
namespace DF.RealEstate.Core.Base
{
    public abstract class RealEstateQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected RealEstateQueryBase(string fieldName,
