(function () {
  $(function () {
    ...
    var dataTable = _$textsTable.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          rowAction: {
            element: $(
              '<button class="btn btn-outline-primary btn-sm btn-icon" title="' +
                app.localize('Edit') +
    ...
    $('#TextBaseLanguageSelectionCombobox,#TextTargetLanguageSelectionCombobox').selectpicker({
      iconBase: 'famfamfam-flag',
      tickIcon: 'fa fa-check',
    });

    $('#TextSourceSelectionCombobox,#TargetValueFilterSelectionCombobox').selectpicker({
      iconBase: 'fa',
      tickIcon: 'fa fa-check',
    });
