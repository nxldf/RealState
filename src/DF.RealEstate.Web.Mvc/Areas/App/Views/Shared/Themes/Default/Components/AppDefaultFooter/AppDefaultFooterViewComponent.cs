...
namespace DF.RealEstate.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultFooter
{
    public class AppDefaultFooterViewComponent : RealEstateViewComponent
    {
