...
using DF.RealEstate.Configuration.Host;
using DF.RealEstate.Editions;
using DF.RealEstate.Timing;
using DF.RealEstate.Timing.Dto;
using DF.RealEstate.Web.Areas.App.Models.HostSettings;
...
namespace DF.RealEstate.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : RealEstateControllerBase
    {
