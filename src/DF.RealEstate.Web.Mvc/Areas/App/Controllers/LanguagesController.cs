...
using DF.RealEstate.Web.Areas.App.Models.Languages;
...
namespace DF.RealEstate.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : RealEstateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = RealEstateConsts.LocalizationSourceName;
            }
