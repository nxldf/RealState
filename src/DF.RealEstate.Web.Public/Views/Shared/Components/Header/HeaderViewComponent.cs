...
using DF.RealEstate.Web.Public.Startup;
using DF.RealEstate.Web.Session;

namespace DF.RealEstate.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : RealEstateViewComponent
    {
