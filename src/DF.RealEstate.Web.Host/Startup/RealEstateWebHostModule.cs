...
using DF.RealEstate.Web.Startup.ExternalLoginInfoProviders;
...
namespace DF.RealEstate.Web.Startup
{
    ...
    public class RealEstateWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RealEstateWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RealEstateWebHostModule).GetAssembly());
        }
