...
using DF.RealEstate.Authentication.TwoFactor;
using DF.RealEstate.Chat;
using DF.RealEstate.Configuration;
using DF.RealEstate.EntityFrameworkCore;
using DF.RealEstate.Startup;
using DF.RealEstate.Web.Authentication.JwtBearer;
using DF.RealEstate.Web.Authentication.TwoFactor;
using DF.RealEstate.Web.Chat.SignalR;
using DF.RealEstate.Web.Common;
using DF.RealEstate.Web.Configuration;
using DF.RealEstate.Web.DashboardCustomization;

namespace DF.RealEstate.Web
{
    [DependsOn(
        typeof(RealEstateApplicationModule),
        typeof(RealEstateEntityFrameworkCoreModule),
    ...
    public class RealEstateWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RealEstateWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(RealEstateApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RealEstateWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(RealEstateWebCoreModule).Assembly);
        }
