...
namespace DF.RealEstate.Web.Authentication.JwtBearer
{
    public class RealEstateJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public RealEstateJwtSecurityTokenHandler()
        {
