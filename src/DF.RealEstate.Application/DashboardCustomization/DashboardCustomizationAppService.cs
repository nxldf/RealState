...
namespace DF.RealEstate.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : RealEstateAppServiceBase, IDashboardCustomizationAppService
    {
