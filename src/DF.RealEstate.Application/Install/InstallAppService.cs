...
using DF.RealEstate.Migrations.Seed;
...
namespace DF.RealEstate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : RealEstateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<RealEstateDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{RealEstateConsts.ConnectionStringName}", constring);
        }
