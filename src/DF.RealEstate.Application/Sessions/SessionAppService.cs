...
using DF.RealEstate.UiCustomization;
...
{
    public class SessionAppService : RealEstateAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = RealEstateConsts.Currency,
                        CurrencySign = RealEstateConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = RealEstateConsts.AllowTenantsToChangeEmailSettings,
