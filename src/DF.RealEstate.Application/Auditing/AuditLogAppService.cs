...
using DF.RealEstate.Auditing.Exporting;
using DF.RealEstate.Authorization;
using DF.RealEstate.Authorization.Users;
using DF.RealEstate.Dto;
using DF.RealEstate.EntityHistory;
using EntityHistoryHelper = DF.RealEstate.EntityHistory.EntityHistoryHelper;

namespace DF.RealEstate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RealEstateAppServiceBase, IAuditLogAppService
    {
