...
using DF.RealEstate.MultiTenancy.Payments.Stripe;
using DF.RealEstate.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace DF.RealEstate.MultiTenancy.Payments
{
    public class StripePaymentAppService : RealEstateAppServiceBase, IStripePaymentAppService
    {
