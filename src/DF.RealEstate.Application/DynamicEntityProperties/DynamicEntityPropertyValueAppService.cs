...
using DF.RealEstate.DynamicEntityPropertyValues.Dto;
...
namespace DF.RealEstate.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : RealEstateAppServiceBase, IDynamicEntityPropertyValueAppService
    {
