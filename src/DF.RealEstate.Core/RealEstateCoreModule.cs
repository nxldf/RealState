...
using DF.RealEstate.Authorization.Ldap;
...
using DF.RealEstate.DashboardCustomization.Definitions;
using DF.RealEstate.Debugging;
using DF.RealEstate.DynamicEntityProperties;
using DF.RealEstate.Features;
...
using DF.RealEstate.Net.Emailing;
using DF.RealEstate.Notifications;
using DF.RealEstate.WebHooks;
using Newtonsoft.Json;

namespace DF.RealEstate
{
    [DependsOn(
        typeof(RealEstateCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class RealEstateCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            RealEstateLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = RealEstateConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, RealEstateMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<RealEstateSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RealEstateCoreModule).GetAssembly());
        }
