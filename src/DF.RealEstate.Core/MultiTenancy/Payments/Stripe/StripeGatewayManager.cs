...
namespace DF.RealEstate.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : RealEstateServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "RealEstate";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + RealEstateConsts.Currency;
        }
