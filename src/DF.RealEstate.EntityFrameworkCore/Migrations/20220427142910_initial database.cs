        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AmenityTranslations_Amenities_CoreId",
                        column: x => x.CoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HidePreciseLocation = table.Column<bool>(type: "bit", nullable: false),
                    ContactByPhone = table.Column<bool>(type: "bit", nullable: false),
                    ContactByEmail = table.Column<bool>(type: "bit", nullable: false),
                    ContactSiteMessage = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeAmenities", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityTranslations_CoreId",
