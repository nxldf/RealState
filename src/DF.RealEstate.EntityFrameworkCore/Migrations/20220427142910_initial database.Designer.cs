...
namespace DF.RealEstate.Migrations
{
    ...
    [Migration("20220427142910_initial database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DF.RealEstate.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.Advertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("ContactSiteMessage")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("HidePreciseLocation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.Amenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.AmenityTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.Home", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.HomeAmenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.HomePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DF.RealEstate.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DF.RealEstate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DF.RealEstate.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.City", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Addresses.Province", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.District", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Addresses.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Addresses.Province", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Addresses.Country", "Country")
                        .WithMany("Provinces")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.Advertisement", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Homes.Home", null)
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.AmenityTranslation", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Homes.Amenity", "Core")
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.Home", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Addresses.District", "District")
                        .WithMany()
            ...
            modelBuilder.Entity("DF.RealEstate.Entities.Homes.HomeAmenity", b =>
                {
                    b.HasOne("DF.RealEstate.Entities.Homes.Amenity", "Amenity")
                        .WithMany("Homes")
                        .HasForeignKey("AmenityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DF.RealEstate.Entities.Homes.Home", "Home")
                        .WithMany("Amenities")
