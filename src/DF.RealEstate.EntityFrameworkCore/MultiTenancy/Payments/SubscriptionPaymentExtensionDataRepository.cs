...
using DF.RealEstate.EntityFrameworkCore.Repositories;

namespace DF.RealEstate.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : RealEstateRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RealEstateDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
