...
{
    public class SubscriptionPaymentRepository : RealEstateRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<RealEstateDbContext> dbContextProvider)
