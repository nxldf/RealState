...
$webMvcFolder = Join-Path $slnFolder "src/DF.RealEstate.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/DF.RealEstate.Web.Public"
...
dotnet restore DF.RealEstate.Web.sln
